...
export function sum(a, b) {
    const sum = a + b;
    const string = `The sum of ${a} and ${b} is ${sum}.`;
    return [sum, string];
}
...
export function multiply(a, b) {
    const sum = a * b;
    const string = `The product of ${a} and ${b} is ${sum}.`;
    return [sum, string];
}
...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    const result = sum(sum(a, b)[0], c)[0];
    const multresult = multiply(multiply(a, b)[0], c)[0];
    const addstring = `${a} and ${b} and ${c} sum to ${result}.`;
    const multstring = `The product of ${a} and ${b} and ${c} is ${multresult}.`;
    return [result, multresult, addstring, multstring];
}
...
export function sumArrayWithThreeNumbers(sumArr) {
    const result = sum(sum(sumArr[0], sumArr[1])[0], (sumArr[2]))[0];
    const string = `2,3,4 was passed in as an array of numbers, and ${result} is their sum.`;
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    const result = multiply(multiply(multArr[0], multArr[1])[0], (multArr[2]))[0];
    const string = `The numbers 2,3,4 have a product of ${result}.`;
    return [result, string];
}
